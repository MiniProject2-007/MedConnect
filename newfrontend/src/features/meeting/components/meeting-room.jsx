...
const MeetingRoom = ({
    ...
    }, [myStream, remoteSocketId, socket, toast]);
    ...
    const handleToggleVideo = useCallback(() => {
        if (myStream) {
            ...
            if (videoTrack) {
                ...
                // Notify other participant about video state change
    ...
    }, [myStream, isVideoOn, remoteSocketId, socket, toast]);
    ...
    }, [isScreenSharing, myStream, toast]);
    ...
    }, [remoteStream, isRemoteAudioMuted, toast]);
    ...
    }, [myStream, remoteStream, remoteSocketId, socket, navigate, toast]);
    ...
    // Start call duration timer when call starts
    useEffect(() => {
    ...
    const handleCallAccepted = useCallback(
        ({ from, ans }) => {
            ...
            // toast({
            //     title: "Call connected",
            //     description: "Video consultation has started.",
            // });
        },
        [sendStreams, toast]
    );
    ...
    // Handle remote user audio/video state changes
    const handleRemoteAudioChange = useCallback(
        ({ isMuted }) => {
            // toast({
            //     title: isMuted
            //         ? "Remote microphone muted"
            //         : "Remote microphone unmuted",
            //     duration: 2000,
            // });
        },
        [toast]
    ...
    const handleRemoteVideoChange = useCallback(
        ({ isVideoOn }) => {
            // toast({
            //     title: isVideoOn
            //         ? "Remote camera turned on"
            //         : "Remote camera turned off",
            //     duration: 2000,
            // });
        },
        [toast]
    ...
    }, [myStream, remoteStream, navigate, toast]);
    ...
    return (
        ...
        >
            ...
            {/* Waiting for participant screen */}
            {!remoteSocketId && connectionStatus !== "disconnected" ? (
                <div className="w-full h-full flex flex-col items-center justify-center bg-gray-100">
                    <div className="bg-white p-8 rounded-xl shadow-lg text-center max-w-md">
                        ...
                        <p className="text-gray-600 mb-6">
                            Your consultation will begin when the doctor joins.
                            Please ensure your camera and microphone are
                            working.
                        </p>
                ...
                <div className="w-full h-full flex flex-col items-center justify-center bg-gray-100">
                    <div className="bg-white p-8 rounded-xl shadow-lg text-center max-w-md">
                        ...
                        <p className="text-gray-600 mb-6">
                            Your doctor is ready for the consultation. Click the
                ...
                <>
                    ...
                    <div className="absolute top-4 left-4 z-20 flex items-center gap-2">
                        <Badge
                            variant="outline"
                            className="bg-black/30 text-white border-none px-3 py-1"
                        >
                                    ...
                                    <Tooltip>
                                        <TooltipTrigger asChild>
                                            <Button
                                                ...
                                                className={`rounded-full h-12 w-12 ${
                                                    isScreenSharing
                                                        ? "bg-[#FF7F50]/20 border-[#FF7F50] text-[#FF7F50]"
                                                        : "border-[#FF7F50] text-[#FF7F50]"
                                                }`}
                                                onClick={
